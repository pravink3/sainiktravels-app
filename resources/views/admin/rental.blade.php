    ...
    <div class="content-area py-1">
        <div class="container-fluid">
            <div class="box box-block bg-white">
                ...
                <h5 style="margin-bottom: 2em;">Car Rental</h5>
                {{--<div align="center">
                ...
                <form class="form-horizontal" >
                    ...
                    <div class="form-group row">
                        <label for="choose country" class="col-xs-2 col-form-label">Country</label>
                        <div class="col-xs-10">
                    ...
                    <div class="form-group row">
                        <label for="discount" class="col-xs-2 col-form-label">State</label>
                        <div class="col-xs-10">
                            <select name="state" id="state"></select>
                    ...
                    <div class="form-group row">
                        <label for="rates" class="col-xs-2 col-form-label">Hourly Rate</label>
                        <div class="col-xs-2">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-xs-10">
                            <button type="" class="btn btn-primary">Update Record</button>
